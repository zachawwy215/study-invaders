...
const TRANSLATIONS = {
  en: {
    ...
    puterNotice2: "If Puter ever says your account is low on balance, just go to Puter, delete your Puter account and create a new account. You can use the same email for this.",
    playBtn: "PLAY",
